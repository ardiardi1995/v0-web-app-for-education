...
export async function POST(request) {
  try {
    console.log(`\n[v0] ╔════════════════════════════════════════╗`);
    console.log(`[v0] ║  SCRAPE KELAS 3-4 STARTED             ║`);
    console.log(`[v0] ╚════════════════════════════════════════╝\n`);
    ...
    console.log(`[v0] Deleting old kelas 3-4 data for re-scraping...`);
    await sql`DELETE FROM videos WHERE kelas IN (3, 4)`;
    ...
    return Response.json({
      success: true,
      message: `Inserted ${totalInserted} videos for kelas 3-4`,
